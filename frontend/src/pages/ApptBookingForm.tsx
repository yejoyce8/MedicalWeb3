...
const ApptBookingForm = (): React.ReactElement => {
  ...
  return (
  <Box style={{ paddingTop: '20px' }} display="flex" flexDirection="column" m="0px auto" w="70%">
    <Heading style={{ paddingTop: '20px', paddingBottom: '20px' }} textStyle="heading1" size="lg">Book Appointment</Heading>
    <Box bg="#F5F5F5" borderRadius="40px" p="20px">
      <Box display="flex" flexDirection="row" alignItems="flex-start" justifyContent="space-between" p="10px" mt="20px">
        <Box w="47%">
      ...
      <Box display="flex" flexDirection="row" alignItems="flex-start" p="10px" mt="20px" >
        <Button colorScheme="blue" bg="blue.100" variant="solid" onClick={handleSchedule} marginRight="10px">
          Confirm my appointment
        </Button>
        <Button colorScheme="blue" bg="blue.100" variant="solid" onClick={() => window.location.assign("/")} marginLeft="10px" >
          Cancel
        </Button>
      </Box>
    </Box>
    {/* Doctor Information */}
    <Heading style={{ paddingTop: '40px' }} textStyle="heading1" size="lg">Doctor's Information</Heading>
  </Box>
);
